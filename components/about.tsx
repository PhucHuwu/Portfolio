...
export function About() {
    return (
        <section id="about" className="flex min-h-screen flex-col md:flex-row items-center justify-center gap-8 px-4 sm:px-6">
            {/* Left: personal photo */}
            <div id="about-image" className="flex-shrink-0 mt-8 md:mt-0 flex items-center justify-center">
            ...
            <div id="about-text" className="pb-16 text-center md:text-left w-full max-w-3xl px-2 sm:px-4">
